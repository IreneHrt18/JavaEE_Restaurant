...
<nav class="navbar navbar-expand-lg navbar-light  bg-success">
    ...
    <div class="collapse navbar-collapse container-fluid" id="navbarNav">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="nav-item ">
                <a class="disabled"  href="./LoginOrSignup.jsp" >欢迎回来，<%=user.getUSERNAME() %></a>
            </li>
        </ul>
    </div>
</nav>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm">
                                <div class="card">
                                    <div class="card-body">
                                        <h6 class="card-title"><%=cart.getDishname()%></h6>
                                        <h6 class="card-subtitle text-right">单价：<%=cart.getDish().getPRICE()%>元</h6>
                                        <form id="form<%=index%>" action="/CartServlet">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control input-sm" id="editAmount<%=index%>" name="editAmount" value="<%=cart.getDishCount()%>" width="auto" readonly >
                                                <div class="input-group-prepend">
